...
由於我們將在 API 呼叫中設定 verify=False，先停用相關的 InsecureRequestWarning
...
# 使用 CWA 36小時天氣預報 API
url = "https://www.google.com/search?q=https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001"
...
try:
    # --- 3. 關鍵修改：加入 verify=False 來繞過 SSL 憑證驗證 ---
